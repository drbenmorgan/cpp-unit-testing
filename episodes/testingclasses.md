...
- Reading the specification before writing tests is not optional — it determines what the tests should assert and surfaces ambiguities in the contract
- Each test case should verify one behaviour — if a test needs "and" in its name it is probably two tests
- GoogleTest does not provide element-wise nearness comparison for vectors — a small helper function fills this gap and is worth keeping as a reusable tool
::::::::::::::::::::::::::::::::::::::::::::::::
